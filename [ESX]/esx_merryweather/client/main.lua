...
RegisterNetEvent('gr8rp_customrob:currentlyRobbing')
AddEventHandler('gr8rp_customrob:currentlyRobbing', function(currentStore)
	holdingUp, store = true, currentStore
end)

RegisterNetEvent('gr8rp_customrob:killBlip')
AddEventHandler('gr8rp_customrob:killBlip', function()
	RemoveBlip(blipRobbery)
end)

RegisterNetEvent('gr8rp_customrob:setBlip')
AddEventHandler('gr8rp_customrob:setBlip', function(position)
...
RegisterNetEvent('gr8rp_customrob:tooFar')
AddEventHandler('gr8rp_customrob:tooFar', function()
	holdingUp, store = false, ''
	exports['mythic_notify']:DoCustomHudText('inform', _U('robbery_cancelled'))
end)

RegisterNetEvent('gr8rp_customrob:robberyComplete')
AddEventHandler('gr8rp_customrob:robberyComplete', function(award)
	holdingUp, store = false, ''
...
RegisterNetEvent('gr8rp_customrob:startTimer')
AddEventHandler('gr8rp_customrob:startTimer', function()
	local merryped2 = GetHashKey('s_m_y_marine_03')
	local gun = GetHashKey('WEAPON_SMG')
	...
	Citizen.CreateThread(function()
		...
		GiveWeaponToPed(merryped1, GetHashKey('WEAPON_SMG'), 250, false, true)
		TaskCombatPed(merryped1, GetPlayerPed(-1))
		SetPedAccuracy(merryped1, 70)
		...
		GiveWeaponToPed(merryped2, GetHashKey('WEAPON_SMG'), 250, false, true)
		TaskCombatPed(merryped2, GetPlayerPed(-1))
		SetPedAccuracy(merryped2, 70)
		...
		GiveWeaponToPed(merryped3, GetHashKey('WEAPON_SMG'), 250, false, true)
		TaskCombatPed(merryped3, GetPlayerPed(-1))
		SetPedAccuracy(merryped3, 70)
		...
		GiveWeaponToPed(merryped4, GetHashKey('WEAPON_SMG'), 250, false, true)
		TaskCombatPed(merryped4, GetPlayerPed(-1))
		SetPedAccuracy(merryped4, 70)
		...
		GiveWeaponToPed(merryped5, GetHashKey('WEAPON_SMG'), 250, false, true)
		TaskCombatPed(merryped5, GetPlayerPed(-1))
		SetPedAccuracy(merryped5, 70)
		...
		GiveWeaponToPed(merryped6, GetHashKey('WEAPON_SMG'), 250, false, true)
		TaskCombatPed(merryped6, GetPlayerPed(-1))
		SetPedAccuracy(merryped6, 70)
		...
		GiveWeaponToPed(merryped7, GetHashKey('WEAPON_RPG'), 2, false, true)
		TaskCombatPed(merryped7, GetPlayerPed(-1))
		SetPedAccuracy(merryped7, 80)
		...
		GiveWeaponToPed(merryped8, GetHashKey('WEAPON_SMG'), 250, false, true)
		TaskCombatPed(merryped8, GetPlayerPed(-1))
		SetPedAccuracy(merryped8, 70)
		...
		GiveWeaponToPed(merryped13, GetHashKey('WEAPON_SMG'), 250, false, true)
		TaskCombatPed(merryped13, GetPlayerPed(-1))
		SetPedAccuracy(merryped13, 70)
		...
		GiveWeaponToPed(merryped14, GetHashKey('WEAPON_SMG'), 250, false, true)
		TaskCombatPed(merryped14, GetPlayerPed(-1))
		SetPedAccuracy(merryped14, 70)
		...
		GiveWeaponToPed(merryped15, GetHashKey('WEAPON_SMG'), 250, false, true)
		TaskCombatPed(merryped15, GetPlayerPed(-1))
		SetPedAccuracy(merryped15, 70)
	...
	while true do
				...
				if not holdingUp then
					...
					if distance < 0.5 then
						...
						if IsControlJustReleased(0, 38) then
							TriggerServerEvent('gr8rp_customrob:robberyStarted', k)
						end
					end
				end
			end
		...
		if holdingUp then
			...
			if Vdist(playerPos.x, playerPos.y, playerPos.z, storePos.x, storePos.y, storePos.z) > Config.MaxDistance then
				TriggerServerEvent('gr8rp_customrob:tooFar', store)
			end
		end
	end
end)
