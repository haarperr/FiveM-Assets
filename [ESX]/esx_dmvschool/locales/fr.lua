Locales['fr'] = {
  ...
  ['in_town_speed'] = 'entrée en ville, attention à votre vitesse! Vitesse limite: %s~s~ km/h',
  ['next_point_speed'] = 'allez vers le prochain passage! Vitesse limite: %s~s~ km/h',
  ['stop_for_ped'] = 'faite rapidement un ~r~stop~s~ pour le piéton qui traverse',
  ['good_lets_cont'] = '~g~Bien!~s~ continuons!',
  ['stop_look_left'] = 'marquer rapidement un ~r~stop~s~ et regardez à votre gauche~s~. Vitesse limite: %s~s~ km/h',
  ['good_turn_right'] = '~g~Bien!~s~ prenez à droite~s~ et suivez votre file',
  ['watch_traffic_lightson'] = 'observez le traffic allumez vos feux~s~!',
  ['stop_for_passing'] = 'marquez le stop pour laisser passer les véhicules!',
  ['hway_time'] = 'il est temps d\'aller sur la rocade! Vitesse limite: %s~s~ km/h',
  ...
  ['driving_too_fast'] = 'vous roulez trop vite, vitesse limite: %s~s~ km/h!',
