Locales['sv'] = {
  ...
  ['next_point_speed'] = 'åk till nästa punkt! hastighetsgräns: %s~s~ km/h',
  ['stop_for_ped'] = '~r~Stanna~s~ för fotgängare som korsar vägen!',
  ['good_lets_cont'] = '~g~Bra~s~, fortsätt.',
  ['stop_look_left'] = '~r~Stanna~s~ och kolla åt vänster~s~. Hastighetsgräns: %s~s~ km/h',
  ['good_turn_right'] = '~g~Bra~s~, sväng höger och följ linjen',
  ['watch_traffic_lightson'] = 'var vaken i trafiken och sätt på dina lampor~s~!',
  ['stop_for_passing'] = '~r~Stanna~s~ för passerande fordon!',
  ['hway_time'] = 'det är dags att köra på motorväg! Hastighetsgräns: %s~s~ km/h',
  ...
  ['driving_too_fast'] = '~r~Du kör för snabbt,~s~ den nuvarande hastighetsgräns är: %s~s~ km/h!',
