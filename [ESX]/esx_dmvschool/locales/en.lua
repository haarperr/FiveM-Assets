Locales['en'] = {
  ...
  ['in_town_speed'] = 'entered town, pay attention to your speed! Speed Limit: %s~s~ km/h',
  ['next_point_speed'] = 'go to the next point! Speed Limit: %s~s~ km/h',
  ['stop_for_ped'] = '~r~Stop~s~ for the pedestrian crossing',
  ['good_lets_cont'] = '~g~Good~s~, continue.',
  ['stop_look_left'] = '~r~Stop~s~ and look left~s~. Speed Limit: %s~s~ km/h',
  ['good_turn_right'] = '~g~Good~s~, turn right and follow the line',
  ['watch_traffic_lightson'] = 'watch the traffic and turn on your lights~s~!',
  ['stop_for_passing'] = '~r~Stop~s~ for passing vehicles!',
  ['hway_time'] = 'it\'s time to drive on the highway! Speed Limit: %s~s~ km/h',
  ...
  ['driving_too_fast'] = '~r~You\'re driving too fast,~s~ the current speed limit is: %s~s~ km/h!',
