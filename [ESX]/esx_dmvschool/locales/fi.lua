Locales['fi'] = {
  ...
  ['in_town_speed'] = 'saavuit kaupunkiin! Seuraa nopeuttasi Nopeusrajoitus: %s~s~ km/h',
  ['next_point_speed'] = 'mene seuraavaan pisteeseen Nopeusrajoitus: %s~s~ km/h',
  ['stop_for_ped'] = '~r~Pysähdy~s~ katso tietä ylittäviä ~s~ jalankulikijoita',
  ['good_lets_cont'] = '~g~Hyvä~s~, jatkakaa.',
  ['stop_look_left'] = '~r~Pysähdy~s~ ja katso vasemmalle~s~. Nopeusrajoitus: %s~s~ km/h',
  ['good_turn_right'] = '~g~Hyvä~s~, käänny oikealle ja seuraa kaistaa',
  ['watch_traffic_lightson'] = 'seuraa liikennettä, ja käänny kun valot ovat vihreät~s~!',
  ['stop_for_passing'] = '~r~Pysähdy~s~ ohi menevien autojen vuoksi',
  ['hway_time'] = 'on aika mennä moottoritielle. Nopeusrajoitus: %s~s~ km/h',
  ...
  ['driving_too_fast'] = '~r~Ajat liian nopeeta! Hidasta!~s~ Nopeusrajoitus: %s~s~ km/h!',
