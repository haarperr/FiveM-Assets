...
Config.Zones = {
	...
	ls2 = {
		Pos   = {x =-88.581840515137, y =-1813.1278076172, z =26.958652496338}, --ghost
	...
	ls6 = {
		Pos   = { x = 934.36, y = -971.0, z = 38.57},
		Size  = {x = 9.0, y = 9.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
		Hint  = _U('press_custom')
