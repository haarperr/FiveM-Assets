...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction then
			...
			if currentZone == "Glasses" then currentZone = "Gafas " end
			if currentZone == "Ears" then currentZone = "Accesorios de orejas " end
			if currentZone == "Helmet" then currentZone = "Sombreros " end
			if currentZone == "Mask" then currentZone = "Mascaras " end



			ESX.ShowFloatingHelpNotification( (CurrentActionMsg..""..currentZone), vector3(currentCoords.x, currentCoords.y, currentCoords.z + 1) )
