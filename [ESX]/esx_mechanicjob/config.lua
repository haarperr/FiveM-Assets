...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = 949.27, y = -963.5, z = 39.5 },
		Size  = { x = 0.5, y = 0.5, z = 0.5 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 2,
		storeText = "Flex ~r~[E]~s~ for Shop Menu",
		textDistance = 1.0
	},

	Craft = {
		Pos   = {x = 955.51062011719, y = -955.05920410156, z = 39.499946594238},
		Size  = { x = 0.5, y = 0.5, z = 0.5 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 2,
		storeText = "Flex ~r~[E]~s~ to Craft",
		textDistance = 1.0
	},

	NitroCraft = {
		Pos		= {x = 955.13751220703, y = -982.61944580078, z = 39.499946594238},
		Size  = { x = 0.5, y = 0.5, z = 0.5 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 2,
		storeText = "Flex ~r~[E]~s~ to Fill Nitro",
		textDistance = 1.0
	},

	VehicleSpawnPoint = {
		Pos   = {x = 936.89373779297, y = -990.90783691406, z = 38.331317901611},
	...
	VehicleDeleter = {
		Pos   = { x = 943.93, y = -944.47, z = 40.0 },
		Size  = { x = 3.0, y = 3.0, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = -1,
		storeText = "Flex ~r~[E]~s~ to Delete Vehicle",
		textDistance = 10.0
	},
	...
	VehicleDelivery = {
		...
		Color = { r = 204, g = 204, b = 0 },
		Type  = -1,
		storeText = "Flex ~r~[E]~s~ to Deliver Tow",
		textDistance = 10.0
	}
}
