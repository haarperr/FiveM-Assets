...
AddEventHandler('esx_eden_clotheshop:pay', function()
	...
	TriggerClientEvent('esx:showNotification:SendNotification', source, _U('you_paid') .. Config.Price)
end)
...
AddEventHandler('esx_eden_clotheshop:returnMoney', function()
	...
	TriggerClientEvent('esx:showNotification:SendNotification', source, 'Se te ha devuelto el dinero')
end)
