...
GUI.Time = 0
local LastZone, CurrentAction, CurrentActionMsg, ccurrentCoords
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction ~= nil then
			...
			ESX.ShowFloatingHelpNotification(CurrentActionMsg, vector3(Config.Zones[currentZone].Pos.x, Config.Zones[currentZone].Pos.y, Config.Zones[currentZone].Pos.z + 1) )
