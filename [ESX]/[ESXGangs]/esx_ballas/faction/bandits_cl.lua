...
local blips = {
  ...
  {title="~p~Quartier ballas", colour=27, id=84, x = 102.8919, y = -1938.8892, z = 20.8037}
  }
  Citizen.CreateThread(function()
      ...
      if data.current.value == 'vehicle_list' then
        ...
        if Config.EnableSocietyOwnedVehicles then
            ...
            if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and
              ...
              table.insert(elements, {label = 'Véhicule du Boss', value = 'baller3'})
            end
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'ballas' and (GetGameTimer() - GUI.Time) > 300 then
        ...
        if CurrentAction == 'menu_armory' then
         ...
         if CurrentAction == 'delete_vehicle' then
           ...
           local plate     = GetVehicleNumberPlateText(vehicle)
           if hash == GetHashKey('brioso') or hash == GetHashKey('exemplar') or hash == GetHashKey('manchez') or hash == GetHashKey('baller3') or hash == GetHashKey('granger')then
            if Config.MaxInService ~= -1 then
